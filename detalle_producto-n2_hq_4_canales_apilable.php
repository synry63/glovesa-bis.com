                ...
                <div class="col-lg-12">
                    <div class="heading-banner k-padding text-center">
                        <div class="page-banner-title">
                            <h2>N2 HQ 4 CANALES APILABRE</h2>
                        </div>
                    </div>
                    <div class="breadcam">
                        <ul>
                            <li><a href="index.php">Inicio</a></li>
                            <li><i class="fa fa-angle-right"></i>N2 HQ 4 CANALES APILABRE</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="product-zoom">
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="home">
                                <img src="img/product/CAJAS_MINERAS_N2/N2_HQ_4_CANALES_APILABLE/caja33.jpg" alt="">
                            </div>
                            <div role="tabpanel" class="tab-pane" id="profile">
                                <img src="img/product/CAJAS_MINERAS_N2/N2_HQ_4_CANALES_APILABLE/caja77.jpg" alt="">
                            </div>
                            <div role="tabpanel" class="tab-pane" id="messages">
                                <img src="img/product/CAJAS_MINERAS_N2/N2_HQ_4_CANALES_APILABLE/caja44.jpg" alt="">
                            </div>
                            <div role="tabpanel" class="tab-pane" id="settings">
                                <img src="img/product/CAJAS_MINERAS_N2/N2_HQ_4_CANALES_APILABLE/caja99.jpg" alt="">
                            </div>
                        </div>
                        <!-- Nav tabs -->
                        <ul class="zoom-tab" role="tablist">
                            <li role="presentation" class="active">
                                <a href="#home" aria-controls="home" role="tab" data-toggle="tab"><img src="img/product/CAJAS_MINERAS_N2/N2_HQ_4_CANALES_APILABLE/caja33.jpg" alt="">
                                </a>
                            </li>
                            <li role="presentation">
                                <a href="#profile" aria-controls="profile" role="tab" data-toggle="tab"><img src="img/product/CAJAS_MINERAS_N2/N2_HQ_4_CANALES_APILABLE/caja77.jpg" alt=""></a>
                            </li>
                            <li role="presentation">
                                <a href="#messages" aria-controls="messages" role="tab" data-toggle="tab"><img src="img/product/CAJAS_MINERAS_N2/N2_HQ_4_CANALES_APILABLE/caja44.jpg" alt=""></a>
                            </li>
                            <li role="presentation">
                                <a href="#settings" aria-controls="messages" role="tab" data-toggle="tab"><img src="img/product/CAJAS_MINERAS_N2/N2_HQ_4_CANALES_APILABLE/caja99.jpg" alt=""></a>
                            </li>
                        </ul>
                    </div>
                </div>
...
<!--                        <h2>HQ 4 CANALES X 2700 GR</h2>-->
                        ...
                        <div class="product-desc">
                            <p>Las bandejas portatestigos No2 Modelo HQ de 4 canales son fabricadas con material de primera Calidad, pasan un estricto control, son apropiados para el almacenamiento, transporte y muestras de testigos, se caracterizan por su ligereza, resistencia y son practicamente irrompibles.</p>
                            <p>Su diseño permite el apilamiento con los testigos ahorrando espacio en su almacenamiento sin deterioro de las muestras.</p>
                        </div>
                        <div class="product-inner-info">
