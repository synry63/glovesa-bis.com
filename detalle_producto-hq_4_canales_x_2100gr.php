                ...
                <div class="col-lg-12">
                    <div class="heading-banner k-padding text-center">
                        <div class="page-banner-title">
                            <h2>HQ 4 CANALES x 2100 GR</h2>
                        </div>
                    </div>
                    <div class="breadcam">
                        <ul>
                            <li><a href="index.php">Inicio</a></li>
                            <li><i class="fa fa-angle-right"></i>HQ 4 CANALES x 2100 GR</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="product-zoom">
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="home">
                                <img src="img/product/CAJAS_MINERAS_N3/HQ_4_CANALES_X_2100_GR/caja77.jpg" alt="">
                            </div>
                            <div role="tabpanel" class="tab-pane" id="profile">
                                <img src="img/product/CAJAS_MINERAS_N3/HQ_4_CANALES_X_2100_GR/caja88.jpg" alt="">
                            </div>
                            <div role="tabpanel" class="tab-pane" id="messages">
                                <img src="img/product/CAJAS_MINERAS_N3/HQ_4_CANALES_X_2100_GR/caja66.jpg" alt="">
                            </div>
                            <div role="tabpanel" class="tab-pane" id="settings">
                                <img src="img/product/CAJAS_MINERAS_N3/HQ_4_CANALES_X_2100_GR/caja10.jpg" alt="">
                            </div>
                        </div>
                        <!-- Nav tabs -->
                        <ul class="zoom-tab" role="tablist">
                            <li role="presentation" class="active">
                                <a href="#home" aria-controls="home" role="tab" data-toggle="tab"><img src="img/product/CAJAS_MINERAS_N3/HQ_4_CANALES_X_2100_GR/caja77.jpg" alt="">
                                </a>
                            </li>
                            <li role="presentation">
                                <a href="#profile" aria-controls="profile" role="tab" data-toggle="tab"><img src="img/product/CAJAS_MINERAS_N3/HQ_4_CANALES_X_2100_GR/caja88.jpg" alt=""></a>
                            </li>
                            <li role="presentation">
                                <a href="#messages" aria-controls="messages" role="tab" data-toggle="tab"><img src="img/product/CAJAS_MINERAS_N3/HQ_4_CANALES_X_2100_GR/caja66.jpg" alt=""></a>
                            </li>
                            <li role="presentation">
                                <a href="#settings" aria-controls="messages" role="tab" data-toggle="tab"><img src="img/product/CAJAS_MINERAS_N3/HQ_4_CANALES_X_2100_GR/caja10.jpg" alt=""></a>
                            </li>
                        </ul>
                    </div>
                </div>
...
<!--                        <h2>HQ 4 CANALES X 2700 GR</h2>-->
                        ...
                        <div class="product-desc">
                            <p>Las bandejas portatestigos Modelo HQ de 4 canales son fabricadas con material de primera Calidad, pasan un estricto control de calidad, son apropiados para el almacenamiento, transporte de pruebas y muestras, se caracterizan por su ligereza, resistencia y son practicamente irrompibles.</p>
                            <p>Son apilables y permite el almacenamiento mixto con el modelo NQ.</p>
                        </div>
                        <div class="product-inner-info">
