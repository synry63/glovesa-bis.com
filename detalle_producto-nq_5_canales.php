                ...
                <div class="col-lg-12">
                    ...
                    <div class="breadcam">
                        <ul>
                            ...
                            <li><i class="fa fa-angle-right"></i>NQ 5 CANALES</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="product-zoom">
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="home">
                                <img src="img/product/CAJAS_MINERAS_N4_INSERTABLE_SIN_FALDA/NQ_5_CANALES/caja22.jpg" alt="">
                            </div>
                            <div role="tabpanel" class="tab-pane" id="profile">
                                <img src="img/product/CAJAS_MINERAS_N4_INSERTABLE_SIN_FALDA/NQ_5_CANALES/caja44.jpg" alt="">
                            </div>
                            <div role="tabpanel" class="tab-pane" id="messages">
                                <img src="img/product/CAJAS_MINERAS_N4_INSERTABLE_SIN_FALDA/NQ_5_CANALES/caja11.jpg" alt="">
                            </div>
                            <div role="tabpanel" class="tab-pane" id="settings">
                                <img src="img/product/CAJAS_MINERAS_N4_INSERTABLE_SIN_FALDA/NQ_5_CANALES/caja55.jpg" alt="">
                            </div>
                        </div>
                        <!-- Nav tabs -->
                        <ul class="zoom-tab" role="tablist">
                            <li role="presentation" class="active">
                                <a href="#home" aria-controls="home" role="tab" data-toggle="tab"><img src="img/product/CAJAS_MINERAS_N4_INSERTABLE_SIN_FALDA/NQ_5_CANALES/caja22.jpg" alt="">
                                </a>
                            </li>
                            <li role="presentation">
                                <a href="#profile" aria-controls="profile" role="tab" data-toggle="tab"><img src="img/product/CAJAS_MINERAS_N4_INSERTABLE_SIN_FALDA/NQ_5_CANALES/caja44.jpg" alt=""></a>
                            </li>
                            <li role="presentation">
                                <a href="#messages" aria-controls="messages" role="tab" data-toggle="tab"><img src="img/product/CAJAS_MINERAS_N4_INSERTABLE_SIN_FALDA/NQ_5_CANALES/caja11.jpg" alt=""></a>
                            </li>
                            <li role="presentation">
                                <a href="#settings" aria-controls="messages" role="tab" data-toggle="tab"><img src="img/product/CAJAS_MINERAS_N4_INSERTABLE_SIN_FALDA/NQ_5_CANALES/caja55.jpg" alt=""></a>
                            </li>
                        </ul>
                    </div>
                </div>
...
<!--                        <h2>HQ 4 CANALES X 2700 GR</h2>-->
                        ...
                        <div class="product-desc">
                            <p>Las bandejas portatestigos No4 NQ de 5 canales son fabricadas con material de primera Calidad, pasan un estricto control, son apropiados para el almacenamiento, transporte y muestras de testigos, se caracterizan por su ligereza, resistencia y son practicamente irrompibles.</p>
                            <p>Su diseño sin falda lo hace insertable lograndose con ello un ahorro de espacio en el almacenamiento de las bandejas antes de ser utilizadas ademas de facilitar y optimizar su transporte</p>
                        </div>
                        <div class="product-inner-info">
