...
<?php include('./include/menu.php')?>
                ...
                <div class="col-lg-12">
                    <div class="heading-banner k-padding text-center">
                        <div class="page-banner-title">
                            <h2>N2 NQ 5 CANALES X 1600 GR</h2>
                        </div>
                    </div>
                    <div class="breadcam">
                        <ul>
                            <li><a href="index.php">Inicio</a></li>
                            <li><i class="fa fa-angle-right"></i>N2 NQ 5 CANALES X 1600 GR</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <!-- End Shop-Details Header -->
    <!-- Start Shop Details Area -->
    <div class="shop-details-area k-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-sm-12 col-xs-12 res-margin">
                    <div class="product-zoom">
                        <!-- Tab panes -->
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="home">
                                <img src="img/product/CAJAS_MINERAS_N2/N2_NQ_5_CANALES_X_1600_GR/caja33.jpg" alt="">
                            </div>
                            <div role="tabpanel" class="tab-pane" id="profile">
                                <img src="img/product/CAJAS_MINERAS_N2/N2_NQ_5_CANALES_X_1600_GR/caja44.jpg" alt="">
                            </div>
                            <div role="tabpanel" class="tab-pane" id="messages">
                                <img src="img/product/CAJAS_MINERAS_N2/N2_NQ_5_CANALES_X_1600_GR/caja22.jpg" alt="">
                            </div>
                            <div role="tabpanel" class="tab-pane" id="settings">
                                <img src="img/product/CAJAS_MINERAS_N2/N2_NQ_5_CANALES_X_1600_GR/caja66.jpg" alt="">
                            </div>
                        </div>
                        <!-- Nav tabs -->
                        <ul class="zoom-tab" role="tablist">
                            <li role="presentation" class="active">
                                <a href="#home" aria-controls="home" role="tab" data-toggle="tab"><img src="img/product/CAJAS_MINERAS_N2/N2_NQ_5_CANALES_X_1600_GR/caja33.jpg" alt="">
                                </a>
                            </li>
                            <li role="presentation">
                                <a href="#profile" aria-controls="profile" role="tab" data-toggle="tab"><img src="img/product/CAJAS_MINERAS_N2/N2_NQ_5_CANALES_X_1600_GR/caja44.jpg" alt=""></a>
                            </li>
                            <li role="presentation">
                                <a href="#messages" aria-controls="messages" role="tab" data-toggle="tab"><img src="img/product/CAJAS_MINERAS_N2/N2_NQ_5_CANALES_X_1600_GR/caja22.jpg" alt=""></a>
                            </li>
                            <li role="presentation">
                                <a href="#settings" aria-controls="messages" role="tab" data-toggle="tab"><img src="img/product/CAJAS_MINERAS_N2/N2_NQ_5_CANALES_X_1600_GR/caja66.jpg" alt=""></a>
                            </li>
                        </ul>
                    </div>
                </div>
...
<!--                        <h2>HQ 4 CANALES X 2700 GR</h2>-->
                        ...
                        <div class="product-desc">
                            <p>Las bandejas portatestigos No2 Modelo NQ de 5 canales son fabricadas con material de primera Calidad, pasan un estricto control de calidad, son apropiados para la industria minera en el almacenamiento, transportede pruebas y muestras, se caracterizan por su ligereza, resistencia y son practicamente irrompibles, facilmente apilables, es impermeable y no se corroe, resistente a los rayos ultravioleta y es mas durable en el campo.</p>
                        </div>
                        <div class="product-inner-info">
                        ...
                        <!-- <div class="product-c-z-info">
                            ...
                            <div class="cart-action">
                                <button class="kp-button">Add to Cart</button>
                            </div>
                        </div> -->
                ...
                <div class="col-md-12">
                    <div class="review-area k-padding-top-4">
                        ...
                        <div class="tab-content">
                                ...
                                <div class="p-des-re">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                        <div class="p-des-re-characteristics">
                                            ...
                                            <ul class="p-des-re-menu">
                                                <li>proceso:</li>
                                                <li>medidas aprox.:</li>
                                                <li>alojamiento:</li>
                                                <li>peso:</li>
                                                <li>numero de canales:</li>
                                                <li>capacidad:</li>
                                                <li>color:</li>
                                                <li>material:</li>
                                                <li>temperatura de trabajo:</li>
                                            </ul>
                                            <ul class="p-des-re-menu">
                                                <li>inyección</li>
                                                <li>(1068x388x78)±1mm</li>
                                                <li>72 mm</li>
                                                <li>2,700 ± 200 g</li>
                                                <li>4</li>
                                                <li>4 m lineales</li>
                                                <li>rojo, azul, Negro, otros</li>
                                                <li>polipropileno atoxico</li>
                                                <li>hasta 120 oC</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                        <div class="p-des-re-characteristics">
                                            <h3 class="p-des-re-title">Separador</h3>
                                            <ul class="p-des-re-menu">
                                                <li>proceso</li>
                                                <li>medidas aprox.</li>
                                                <li>alojamiento</li>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                        <div class="p-des-re-characteristics">
                                            <h3 class="p-des-re-title">Tapa</h3>
                                            <ul class="p-des-re-menu">
                                                <li>proceso</li>
                                                <li>medidas aprox.</li>
                                                <li>alojamiento</li>
                                ...
                                <div class="p-des-re customer-review">
                                    ...
                                    <div class="row">
                                        <div class="review-body">
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 single-customer-r">
                                                <div class="c-r-img">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-5">
                                                            <div class="input-mail">
                                                                ...
                                                                <input type="text" placeholder="Summary of your review..." name="review">
                                                            </div>
                                                            <div class="submit-text">
                                                                <button type="submit" class="kp-button">submit review</button>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-7">
                                                            <div class="review-mess">
                                                                <textarea rows="5" placeholder="Your Review" name="message"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
                            ...
                            <div role="tabpanel" class="tab-pane" id="re-p-3">
                                <div class="p-des-re custom-tag">
                                    <h4>Add Product Custom Tags</h4>
                                    <form action="#">
                                        <div class="tag-action-s">
                                            <input type="text" placeholder="Add Tag">
                                            <button class="cus-tag">Add Tag</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
    ...
    <!--<div class="new-product-area k-padding-b">-->
    <!--    <div class="container">-->
    <!--        <div class="row">-->
    <!--            <div class="col-md-12">-->
