...
<html class="no-js" lang="">
    <head>
        ...
        <title>Oshop | Registration</title>
	   ...
	   <link href='https://fonts.googleapis.com/css?family=Raleway:400,800,900,700,600,500' rel='stylesheet' type='text/css'>
    ...
    <body>
						...
						<div class="col-md-6 col-sm-12 col-xs-12">
							<div class="search text-center">
								<form action="#" >
									...
									<button class="my-btn"><i class="fa fa-search"></i></button>
								</form>
							</div>
						</div>
						<div class="col-md-3 col-sm-12 col-xs-12">
							<div class="cart floatright">
								<div class="mincart">
									<a href="cart.html">
										<span class="img"><img src="img/icon/4.png" alt="Cart"></span>
										<span class="min-cart-item">
											<span class="c-title">Shopping Cart</span>
											<span class="count">02 Items</span>
											$2,000
										</span>
									</a>
								</div>	
							<ul>
								<li>
									<div class="cart-img">
										<a href="#"><img alt="" src="img/product/2.jpg"></a>
									</div>
									<div class="cart-info">
										<h4><a href="#">hug he me</a></h4>
								...
								<li>
									<a href="cart.html" class="v-cart o-btn">View Cart</a>
									<a href="checkout.html" class="checkout o-btn">checkout</a>
								</li>
							</ul>									
							</div>
						</div>
									...
									<li><a href="shop.html">jewllery</a>
										<div class="mega-menu">
											...
											<span class="mega-menu-img">
												<a href="shop.html"><img src="img/bannar/1.jpg" alt="Bannar One" /></a>
											</span>
										</div>											
									</li>
									<li><a href="#">Pages</a>
					...
					<div class="col-lg-12">
						...
						<div class="breadcam">
							<ul>
								...
								<li><i class="fa fa-angle-right"></i>Registration</li>
							</ul>
						</div>
					</div>
				</div>
		...
		<div class="registration-area contact-us-area k-padding">
			<div class="container">	
				<div class="row">
							...
							<div class="form-inner">
								<form action="#">
									...
									<div class="single-input one-half">
										...
										<input type="text" required="required" placeholder="Phone Number">
									</div>
									<div class="single-input">
									...
									<div class="single-input one-half">
										...
										<input type="text" required="required" placeholder="State">
									</div>
									<div class="single-input one-half">
										<label>Zip Code <span>*</span></label>
										<input type="text" required="required" placeholder="Zip Code">
									</div>																			
									<div class="custom-select single-input one-half">
										<label>Select Country Name<span>*</span></label>
									...
									<div class="custom-select single-input one-half">
										<label>Select Town / City<span>*</span></label>
										<select class="form-control">
									...
									<div class="reg-button k-padding-top-4">
										<a href="index.php" class="kp-button floatleft">Beck to Home</a>
										<button class="kp-button floatright" type="submit">Register</button>
									</div>
								</form>
							</div>
						</div>				
						...
						<div class="footer-widget">
							...
							<ul class="footer-contact">
								...
								<li>
									...
									Email: admin@websbucket.com <br>
									info@websbucket.com
								</li>
								<li>
									<i class="fa fa-phone"> </i>
									Phone: +880 1835037681 <br>
									+880 1720000000
								</li>
							</ul>
						</div>
		...
		<script src="lib/js/home.js" type="text/javascript"></script>		
		<!-- plugins js -->
