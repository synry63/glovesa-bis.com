            ...
            <div class="col-lg-12">
                ...
                <div class="breadcam">
                    <ul>
                        ...
                        <li><i class="fa fa-angle-right"></i>HQ 4 CANALES X 2700 GR</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="product-zoom">
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="home">
                            <img src="img/product/CAJAS_MINERAS_N1/HQ_4_CANALES_X_2700_gr/caja7.jpg" alt="">
                        </div>
                        <div role="tabpanel" class="tab-pane" id="profile">
                            <img src="img/product/CAJAS_MINERAS_N1/HQ_4_CANALES_X_2700_gr/caja8.jpg" alt="">
                        </div>
                        <div role="tabpanel" class="tab-pane" id="messages">
                            <img src="img/product/CAJAS_MINERAS_N1/HQ_4_CANALES_X_2700_gr/caja2.jpg" alt="">
                        </div>
                        <div role="tabpanel" class="tab-pane" id="settings">
                            <img src="img/product/CAJAS_MINERAS_N1/HQ_4_CANALES_X_2700_gr/caja5.jpg" alt="">
                        </div>
                    </div>
                    <!-- Nav tabs -->
                    <ul class="zoom-tab" role="tablist">
                        <li role="presentation" class="active">
                            <a href="#home" aria-controls="home" role="tab" data-toggle="tab"><img src="img/product/CAJAS_MINERAS_N1/HQ_4_CANALES_X_2700_gr/caja7_t.jpg" alt="">
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#profile" aria-controls="profile" role="tab" data-toggle="tab"><img src="img/product/CAJAS_MINERAS_N1/HQ_4_CANALES_X_2700_gr/caja88.jpg" alt=""></a>
                        </li>
                        <li role="presentation">
                            <a href="#messages" aria-controls="messages" role="tab" data-toggle="tab"><img src="img/product/CAJAS_MINERAS_N1/HQ_4_CANALES_X_2700_gr/caja22.jpg" alt=""></a>
                        </li>
                        <li role="presentation">
                            <a href="#settings" aria-controls="messages" role="tab" data-toggle="tab"><img src="img/product/CAJAS_MINERAS_N1/HQ_4_CANALES_X_2700_gr/caja55.jpg" alt=""></a>
                        </li>
                    </ul>
                </div>
            </div>
